...
public class TexWillerList  extends AppCompatActivity {

    private static final String TAG = "TexWillerList";
        ...
        mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                if(itemID > -1){
                    ...
                    Intent editScreenIntent = new Intent(TexWillerList.this, EditDataActivityTw.class);
